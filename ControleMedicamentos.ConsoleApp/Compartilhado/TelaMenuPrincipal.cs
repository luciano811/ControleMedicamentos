...
namespace ControleMedicamentos.ConsoleApp.Compartilhado
{
    public class TelaMenuPrincipal
    {
        ...
        public TelaMenuPrincipal(Notificador notificador)
        {
            ...
            telaCadastroRequisicao = new TelaCadastroRequisicao(repositorioRequisicao,repositorioMedicamento,telaCadastroMedicamento, telaCadastroPaciente, repositorioPaciente, notificador);
        }
        ...
        public string MostrarOpcoes()
        {
            ...
            Console.WriteLine("\nDigite 3 para Gerenciar Medicamentos");
